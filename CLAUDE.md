...
**"Which role should I take on today - Manager, Developer, or Release Manager?"**

**Then:**
1. Wait for their response
2. Switch to `claude/manager/`, `claude/developer/`, or `claude/release-manager/`
...
All technical details, build instructions, architecture information, coding standards, and role-specific workflows are documented in those guides.
