# Blackbox Serial Logging Workflow for navEPH Capture

**Purpose:** Capture navEPH data at 100 Hz to investigate GPS fluctuation (Issue #11202)

**Method:** Serial blackbox logging with `blackbox_rate_denom = 100`
...
- Sets `blackbox_rate_denom = 100` → **100 Hz logging**
...
| blackbox_rate_denom | 100 | Log every 100th cycle → 10 Hz |
...
# denom=10 should be safe (100 Hz)
```
...
1. **Use real hardware:**
   ...
   - Same configuration (blackbox_rate_denom=100, debug_mode=20)
...
**If 0.198 Hz cycle exists:**
- FFT will show peak at 0.198 Hz
- Time-domain plot shows oscillation period of ~5000ms
- navEPH varies cyclically

**If 0.198 Hz is artifact:**
- No 0.198 Hz peak in spectrum
