#!/usr/bin/env python3
"""
Search the pre-built ICM40609D datasheet index, then extract matched pages
...
The index covers the ICM40609D IMU datasheet:
  ICM40609D-Index  → ../ICM40609D-datasheet.pdf
                     (register map, FIFO, gyro/accel config, self-test,
                      interrupts, power management, electrical specs)
...
INDEXES = {
    "ICM40609D-Index": {
        "description": "IMU datasheet (register map, FIFO, gyro/accel config, self-test, interrupts, power management)",
        "pdf": "../ICM40609D-datasheet.pdf",
    },
}
...
def main():
    parser = argparse.ArgumentParser(
        description="Search ICM40609D datasheet index and extract PDF pages",
