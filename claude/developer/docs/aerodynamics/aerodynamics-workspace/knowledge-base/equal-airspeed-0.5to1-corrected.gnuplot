...
set output 'equal-airspeed-0.5to1-corrected.png'

set title "Equal Airspeeds - 0.5:1 T/W Aircraft" font "Arial,28"
set xlabel ""
set ylabel ""
...
# 50% throttle - 8.6 degrees (symmetry point)
ang50 = 8.6
...
set label "8.6° (symmetry)" at ox+len*cos(ang50*pi/180)+0.3,oy+len*sin(ang50*pi/180)-0.4 font "Arial,14" tc rgb "green"

# 100% throttle - 23.6 degrees
ang100 = 23.6
set arrow from ox,oy to ox+len*cos(ang100*pi/180),oy+len*sin(ang100*pi/180) lw 6 lc rgb "red" head filled
set label "100% Throttle" at ox+len*cos(ang100*pi/180)+0.3,oy+len*sin(ang100*pi/180)+0.3 font "Arial,16" tc rgb "red"
set label "23.6° climb" at ox+len*cos(ang100*pi/180)+0.3,oy+len*sin(ang100*pi/180)-0.1 font "Arial,14" tc rgb "red"
...
set label "Envelope width: 29.3°" at -1.5,-1.9 font "Arial,16" tc rgb "black"
