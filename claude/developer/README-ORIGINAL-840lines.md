...
Use the **check-pr-bots** agent to view bot comments:

```
Task tool with subagent_type="check-pr-bots"
Prompt: "Check PR #11220 for bot comments" or "Check fix-blackbox-bug for bot suggestions"
```
...
## check-pr-bots
**Purpose:** Check pull requests for automated bot comments (qodo-merge, Copilot, GitHub Actions)

**When to use:**
- After creating a PR (wait 3 minutes for bots to analyze)
- Reviewing bot suggestions before finalizing a PR

**Context to provide:**
- PR number, branch name, or task name (e.g., `11220`, `fix-blackbox-bug`, `PR #11220`)

**Example prompts:**
```
"Check PR #11220 for bot comments"
"Check fix-blackbox-bug for bot suggestions"
"Show me qodo comments on PR 11220"
"What did the bots say about my PR for task esc-passthrough-bluejay-am32"
```

**Configuration:** `.claude/agents/check-pr-bots.md`
...
- `check-pr-bots` - Check PR bot comments (qodo, Copilot, GitHub Actions)
