...
|---------|------|----------|----------|-------------|
| [test-nexus-dsm-verification](active/test-nexus-dsm-verification/) | Testing | MEDIUM | 2-4h | Verify DSM receiver works on NEXUS target (PR #11324) |
| [update-stm32f7-hal](active/update-stm32f7-hal/) | Maintenance | HIGH | 16-26h | Update F7xx HAL V1.2.2→V1.3.3 and CMSIS |
...
See [backburner/INDEX.md](backburner/INDEX.md) for details.

---

## Completed

See [completed/INDEX.md](completed/INDEX.md) — 42 projects archived.
