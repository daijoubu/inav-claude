...
OUT_PATH = f'{BASE}/claude/projects/active/rp2350-pin-assignment-plan/rp2350-pico2-inav-pinout.png'
...
RIGHT_PINS = [
    ...
    ('M1',                    'motor'),  # GP8  PIO0 SM0 DShot
    ('M2',                    'motor'),  # GP9  PIO0 SM1 DShot
    ('GND',                   'power'),
    ('M3',                    'motor'),  # GP10 PIO0 SM2 DShot
    ('M4',                    'motor'),  # GP11 PIO0 SM3 DShot
    ('UART3 TX / SERVO 3',   'servo'),  # GP12 PIO1 SM0 / PWM6A dual-use
    ('UART3 RX / SERVO 4',   'servo'),  # GP13 PIO1 SM1 / PWM6B dual-use
    ('GND',                   'power'),
