...
**Actual Effort:** ~2-3 hours (completed as part of PR #11222)
**Milestone:** 9.1
**GitHub Issue:** [#11208](https://github.com/iNavFlight/inav/issues/11208)
**PR:** [#11222](https://github.com/iNavFlight/inav/pull/11222) - MERGED 2026-01-11

## Completion Summary

Successfully completed 2 of 3 objectives in PR #11222. The third objective (reducing upper limit to 1.5) was explicitly decided against based on community feedback.

**What was implemented:**
1. ❌ **Upper limit kept at 2.0** - Initial implementation tried 1.5, but after testing and community feedback, the decision was made to keep the upper limit at 2.0 for better high-speed performance
2. ✅ **I-term scaling reduced** - Reduced I-term scaling to prevent integral windup at low speeds, following best practices from established autopilot systems
3. ✅ **Default disabled (apa_pow = 0)** - APA now defaults to disabled, requiring pilots to explicitly enable after validating their pitot sensor

**Note on 2.0 decision:** The upper limit of 2.0 was retained after testing showed it provided better performance at high speeds without introducing safety concerns, especially with the new pitot validation system in place.

## Overview

Fix three issues with Fixed Wing APA (Airspeed-based PID Attenuation) formula:
1. ~~Change scaling limits from [0.3, 2.0] to [0.5, 1.5]~~ **Decision: Keep 2.0 upper limit**
