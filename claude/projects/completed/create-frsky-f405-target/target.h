...
#define BEEPER                  PC15
#define BEEPER_INVERTED              // Active low (BUZZ-_MCU signal)
...
#define GYRO_INT_EXTI          PC4      // GYRO.INT1 signal
...
// SD Card on SPI3
// NOTE: PC14 used for CS (Chip Select) - unusual but likely okay
// CS is a slow control signal (not high-speed like CLK/MOSI/MISO)
// PC14 is OSC32_IN (RTC domain) but should handle slow GPIO toggling fine
#define USE_SDCARD
#define USE_SDCARD_SPI
#define SDCARD_SPI_BUS          BUS_SPI3
#define SDCARD_CS_PIN           PC14    // Unusual but CS is slow signal, should work
...
#define CURRENT_METER_SCALE     250     // TODO: Calibrate based on INA139 + 0.25mΩ
...
// *************** PWM OUTPUTS *********************
// 9 motor outputs (S1-S9) - all confirmed with timer assignments
// Note: R1-R6/T1-T6 labels on connectors are UART RX/TX pairs, not servo outputs
...
//
// DESIGN NOTES:
// 1. PC14 used for SPI3_NSS (SD card CS) - RTC clock domain, shiuld be fine
//
// 2. Status LEDs share SWD debug pins (PA13/PA14) - HANDLED WITH #ifndef DEBUG_BUILD ⚠️
...
//    This is normal for space-constrained flight controllers
//    Red LED appears to be power indicator (always-on, no GPIO control needed)
//
// PIN CONFLICTS (target or user user must choose):
...
//
// MISSING INFORMATION:
// 8. Gyro orientation (IMU_ALIGN) unknown - needs physical board inspection
// 9. USB VBUS sensing pin not clearly defined
