...
**Created:** 2025-12-29
**Completed:** 2026-01-03 (Investigation phase)
**GitHub Issue:** [#10913](https://github.com/iNavFlight/inav/issues/10913)
**Repository:** inav (firmware)

**Investigation Complete:** Root cause identified - EEPROM save blocking prevents DSHOT frames, causing ESC reboot and motor spinup. Implementation approach documented but deferred pending further research on non-blocking flash solutions.
