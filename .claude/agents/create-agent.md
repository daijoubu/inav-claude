...
**Template file:** `claude/developer/docs/agent-template.md`
...
2. **Copy the template**: `claude/developer/docs/agent-template.md`
3. **Search internal documentation**: Look through `claude/developer/` for:
...
4. **Review existing agents** for reference:
   - `.claude/agents/inav-builder.md`
   - `.claude/agents/sitl-operator.md`
   - `.claude/agents/test-engineer.md`
5. **Gather information** about the agent's purpose
6. **Choose model** - Default to `haiku` for simple, `sonnet` for complex
7. **Write the agent file** using the template
8. **Include related documentation links** in the agent file
9. **Update developer README** (see below)
10. **Verify against checklist**
